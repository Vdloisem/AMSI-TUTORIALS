...
| 10  | `{A, B, F, H}`  | m1        | `{A, B, F, H}`| Same as step 7 |

**Key Concepts Illustrated:**

* **The UML Priority Rule:** This exercise provides a clear, practical example of conflict resolution. The rule—"deepest source state wins"—is not just theoretical; it dictates the machine's behaviour.
